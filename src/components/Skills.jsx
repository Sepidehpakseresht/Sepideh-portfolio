          ...
          {skills.map((skill, index) => (
            ...
            >
              ...
              <motion.div
                ...
                className="glass rounded-2xl p-6 border border-glass-border shadow-orange/20 hover:shadow-orange/40 transition-all duration-300 cursor-pointer relative overflow-hidden"
              >
        ...
        >
          <div className="glass rounded-2xl p-8 border border-glass-border max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Next.js', 'TypeScript', 'Three.js', 'Node.js', 'Testing', 'CI/CD'].map((tech, index) => (
                <span
                  key={tech}
